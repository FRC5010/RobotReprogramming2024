...
public class VisionPhoton extends VisionSystem {
   ...
   * it sets the reference pose or last pose based on the pose strategy. It then retrieves the
   * latest camera result and checks if there are any targets. If there are, it updates the pose
   * estimator and calculates the robot pose estimate. It also updates the dashboard with the target
   * ambiguity. Finally, it updates the raw values with various information about the target and
   * robot pose estimate.
   *
